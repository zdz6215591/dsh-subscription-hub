...
export const en = {
  ...
  poolModeHint: 'One total setting shared by every subscription. Lowers use accounts in order; Balanced picks the account with the most available quota.',
  poolModeReadOverride: 'Saved value overrides YAML config … {configured}',
...
export const zh = {
  ...
  poolModeHint: '这是一个全局总开关，所有订阅共用一个模式：依次=按账号顺序优先使用；均衡=优先调用剩余额度最多的账号。',
  poolModeReadOverride: '已保存的值已覆盖 YAML 配置 {configured}',
